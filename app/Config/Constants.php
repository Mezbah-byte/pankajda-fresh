...
// ----------------------------------------------------------------------
// Pankaj Da ERP - Domain constants
// ----------------------------------------------------------------------
...
defined('PAYMENT_PAID')    || define('PAYMENT_PAID', 'paid');
defined('PAYMENT_PARTIAL') || define('PAYMENT_PARTIAL', 'partial');
defined('PAYMENT_DUE')     || define('PAYMENT_DUE', 'due');

defined('SALE_CASH')   || define('SALE_CASH', 'cash');
defined('SALE_CREDIT') || define('SALE_CREDIT', 'credit');
